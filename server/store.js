...
const AI_USER_PRESET = {
  username: 'ArcadeAI',
  avatar: '🤖',
  tagline: 'Adaptive sparring partner for the Pancake Arena.',
  bio: 'Simulates community meta so you can rehearse escrow flows and strategies.',
  balance: 50_000,
};
...
const TOURNAMENT_PRESETS = [
  {
    ...
    location: 'Syrup Stadium (virtual)',
    entryFee: 25,
    prizePool: 500,
    slots: 32,
...
const CHAT_SEED = [
  {
    username: 'FlipMaster',
    message: 'Welcome to Pi Duel Arena! Spar the AI and then bring a friend.',
  },
  {
    username: 'SyrupQueen',
